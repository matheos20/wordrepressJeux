...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <?php
            if (is_home()){
                echo "<h1>bienvenu dans la page home</h1>";
            }
            if (is_front_page()){
                echo "<h1>bienvenu dans la page front page</h1>";
            }
            if (is_404()){
                echo "<h1>bienvenu dans la page 404</h1>";
            }
            if (is_page()){
                echo "<h1>bienvenu dans la page page</h1>";
            }
            if (is_single()){
                echo "<h1>bienvenu dans la page simple</h1>";
            }
        ?>
